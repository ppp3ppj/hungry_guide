defmodule HungryGuideWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: HungryGuideWeb.Layouts]
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import HungryGuideWeb.CoreComponents
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: HungryGuideWeb.Router,
        statics: HungryGuideWeb.static_paths()
    end
  end
