defmodule HungryGuideWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HungryGuideWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HungryGuideWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  def theme_selector(assigns) do
    ...
    >
      <!-- Desktop Icon -->
      <div tabindex="0" role="button" class="btn group btn-sm gap-1.5 px-1.5 btn-ghost hidden md:flex">
        <!--
        {@label}
        -->
